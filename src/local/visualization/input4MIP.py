...
# Without any satellite driven correction
path_input4mip = f"{home_path}/data/data--processed/output-bundles/v1.0.0/data/processed/esgf-ready/input4MIPs/CMIP7/CMIP/CR/CR-CMIP-1-0-0/"  # noqa: E501
path_base_zonal_ch4 = f"{path_input4mip}/atmos/mon/ch4/gnz/v20250228/"
path_zonal_ch4 = f"{path_base_zonal_ch4}/ch4_input4MIPs_GHGConcentrations_CMIP_CR-CMIP-1-0-0_gnz_175001-202212.nc"  # noqa: E501
...
plt.savefig(
    plots_path + "inputMIP_zonal_ch4_from2003.png", format="png", bbox_inches="tight"
)
plt.close()
